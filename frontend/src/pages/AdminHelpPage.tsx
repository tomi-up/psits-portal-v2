      ...
      <div className="lg:pl-64">
        <header className="flex items-center justify-between gap-3 border-b border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 px-6 py-4 lg:px-10">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-lg font-semibold text-slate-900 dark:text-white">Help &amp; Guide</h1>
              <p className="text-sm text-slate-500 dark:text-slate-400">How to use the PSITS Admin panel</p>
            </div>
          </div>
          <AdminProfileMenu />
        </header>
        ...
        <main className="px-6 py-8 lg:px-10">
          <div className="mx-auto max-w-3xl space-y-8">
            {/* Quick nav */}
            <nav className="flex flex-wrap gap-2 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 p-3">
              {SECTIONS.map((s) => (
                <a
                  key={s.id}
                  href={`#${s.id}`}
                  className="rounded-lg px-3 py-1.5 text-sm font-medium text-sky-600 dark:text-sky-400 transition hover:bg-sky-50"
                >
                  {s.label}
                </a>
              ))}
            ...
            {/* Events */}
            <section id="events" className="scroll-mt-6 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 p-6">
              <div className="mb-4 flex items-center gap-2">
                <CalendarDays className="h-5 w-5 text-sky-600 dark:text-sky-400" />
                <h2 className="text-base font-semibold text-slate-900 dark:text-white">Events</h2>
              </div>

              <div className="space-y-5 text-sm text-slate-600 dark:text-slate-300">
                <div>
                  <p className="font-medium text-slate-900 dark:text-white">Creating an event</p>
                  <p className="mt-1">
                    Go to <span className="font-medium text-slate-800 dark:text-slate-200">Events → Create Event</span> and
                ...
                <div>
                  <p className="font-medium text-slate-900 dark:text-white">Attendance Required</p>
                  <p className="mt-1">
                ...
                <div>
                  <p className="font-medium text-slate-900 dark:text-white">Excused Year Levels</p>
                  <p className="mt-1">
                    ...
                    are marked <span className="font-medium text-indigo-700 dark:text-indigo-400">Excused</span> instead
                    of Absent or Not Registered, and are not required to register.
                  </p>
                </div>

                <div>
                  <p className="font-medium text-slate-900 dark:text-white">Sharing an event</p>
            ...
            {/* Attendance Reports */}
            <section id="attendance" className="scroll-mt-6 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 p-6">
              <div className="mb-4 flex items-center gap-2">
                <ClipboardList className="h-5 w-5 text-sky-600 dark:text-sky-400" />
                <h2 className="text-base font-semibold text-slate-900 dark:text-white">Attendance Reports</h2>
              </div>

              <div className="space-y-5 text-sm text-slate-600 dark:text-slate-300">
                <div>
                  <p className="font-medium text-slate-900 dark:text-white">Opening a report</p>
                  <p className="mt-1 flex items-center gap-1.5">
                ...
                <div>
                  <p className="font-medium text-slate-900 dark:text-white">Reading the statuses</p>
                  <ul className="mt-1 list-disc space-y-1 pl-5">
                    ...
                    <li><span className="font-medium text-indigo-700 dark:text-indigo-400">Excused</span> — in a year level the event exempted; not counted against attendance.</li>
                  </ul>
                </div>

                <div>
                  <p className="font-medium text-slate-900 dark:text-white">Filtering and searching</p>
                  <p className="mt-1">
            ...
            {/* Students */}
            <section id="students" className="scroll-mt-6 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 p-6">
              <div className="mb-4 flex items-center gap-2">
                <IdCard className="h-5 w-5 text-sky-600 dark:text-sky-400" />
                <h2 className="text-base font-semibold text-slate-900 dark:text-white">Students</h2>
              </div>

              <div className="space-y-5 text-sm text-slate-600 dark:text-slate-300">
                <div>
                  <p className="font-medium text-slate-900 dark:text-white">Managing student records</p>
                  <p className="mt-1">
                ...
                <div>
                  <p className="font-medium text-slate-900 dark:text-white">Roster Import</p>
                  <p className="mt-1">
            ...
            <div className="flex items-center gap-2 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 p-5 text-sm text-slate-500 dark:text-slate-400">
